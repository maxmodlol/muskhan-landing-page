...
function AlertDialogPopup({
  ...
  return (
    <AlertDialogPrimitive.Popup
      ...
      className={cn(
        "relative z-50 w-full max-w-md origin-center rounded-2xl border border-earth/12 bg-parchment p-6 text-right shadow-[0_24px_48px_-12px_rgba(63,42,26,0.28)] ring-1 ring-gold/15 transition-[opacity,transform] data-closed:scale-95 data-closed:opacity-0 data-open:scale-100 data-open:opacity-100",
        className
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn("font-heading text-lg font-extrabold text-olive sm:text-xl", className)}
      {...props}
    />
  )
}
